...
| userIp               | 否  | string | 当前用户的ip，使用渠道方收银台的商户可不传，**使用upiIntentString直接唤醒app进行授权的商户必须上传**                                  |
...
``` json
{
  ...
  "data": {
    ...
    "linkUrl": "https://mandate.mycashier.me/payment/page/mandate/cashier/xxxxxxxx", // upi订阅收银台，跳转后唤醒app授权订阅并付款，亦可扫描二维码进行授权
